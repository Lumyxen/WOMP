...
public:
    ...
    bool updatePlaylistMetadata(PlaylistId id, std::string_view name, std::string_view description);
    bool exportPlaylistM3u(PlaylistId id, const std::filesystem::path& path) const;
